...
import 'package:petmapp_cliente/src/pages/alertas_tipos/tipos_alertas_agregar_page.dart';
import 'package:petmapp_cliente/src/pages/alertas_tipos/tipos_alertas_editar_page.dart';
...
class TipoAlertaListarPage extends StatefulWidget {
  TipoAlertaListarPage({Key key}) : super(key: key);

  @override
  _TipoAlertaListarPageState createState() => _TipoAlertaListarPageState();
}

class _TipoAlertaListarPageState extends State<TipoAlertaListarPage> {
  ...
  void _navegartiposalertaAgregar(BuildContext context) {
    var route =
        new MaterialPageRoute(builder: (context) => TipoAlertaAgregarPage());
  ...
  void _navegartiposalertaEditar(BuildContext context, int id) {
    var route = new MaterialPageRoute(
        builder: (context) => TipoAlertaEditarPage(
              id: id,
            ));
    Navigator.push(context, route).then((value) {
      setState(() {});
    ...
    return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: Text('¿Desea borrar el tipo de alerta?'),
            actions: [
              MaterialButton(
                  child: Text('Cancelar',
                      style: TextStyle(
