...
// AGREGAR UBICACION //
  ...
  Future<http.Response> tipoEditar(
    ...
    var urlRequest = apiUrl + 'tiposAlerta/$idTipo';
  ...
  Future<http.Response> tipoBorrar(int id) async {
    var urlRequest = apiUrl + 'tiposAlerta/' + id.toString();
